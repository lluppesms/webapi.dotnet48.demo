////-----------------------------------------------------------------------
//// <copyright file="View_Tbl_DimOffice_Tests.cs" company="Luppes Consulting, Inc.">
//// Copyright 2023, Luppes Consulting, Inc. All rights reserved.
//// </copyright>
//// <summary>
//// Tbl_DimOffice View Controller Tests
//// </summary>
////-----------------------------------------------------------------------
...
//{
//    /// <summary>
//    /// Tbl_DimOffice Controller Test
//    /// </summary>
//    [ExcludeFromCodeCoverage]
//    [TestClass]
//    public class Tbl_DimOfficeControllerEffortTest : BaseEffortTestController
//    {
//        #region Variables
//        /// <summary>
//        /// Repository
...
//        /// The controller
//        /// </summary>
//        private Tbl_DimOfficeController controller;
...
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Index_Works()
//        {
//            // Arrange
...
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Details_NotFound_Fails()
//        {
//            // Arrange
//            var expectedData = new Tbl_DimOffice();
...
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Details_Works()
//        {
//            // Arrange
//            var expectedData = new Tbl_DimOffice();

//            // Act
//            var result = controller.Details(SampleDataManager.TestTbl_DimOffice[0].OfficeID) as ViewResult;
...
//        /// <summary>
//        /// Create Tbl_DimOffice GET Test
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Create_Get_Works()
//        {
//            // Arrange
//            var expectedData = new Tbl_DimOffice();
...
//        /// <summary>
//        /// Create Tbl_DimOffice POST Duplicate Fails
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Create_Post_Fails_Duplicate()
//        {
//            // Arrange
//            var record1 = new Tbl_DimOffice { OfficeID = 89, OfficeName = "Unit Test 89" };
//            var record2 = new Tbl_DimOffice { OfficeID = 90, OfficeName = record1.OfficeName };
...
//        /// <summary>
//        /// Create Tbl_DimOffice POST Works
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Create_Post_Works()
//        {
//            // Arrange
//            var expectedData = new Tbl_DimOffice { OfficeID = 88, OfficeName = "Unit Test 88" };
...
//        /// <summary>
//        /// Edit Tbl_DimOffice GET Works
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Edit_Get_Works()
//        {
//            // Arrange
//            var expectedData = new Tbl_DimOffice();

//            // Act
//            var result = controller.Edit(SampleDataManager.TestTbl_DimOffice[0].OfficeID) as ViewResult;
...
//        /// <summary>
//        /// Edit Tbl_DimOffice GET Not Found Fails
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Edit_NotFound_Fails()
//        {
//            // Arrange
//            var expectedHttpStatus = 404;
...
//        /// <summary>
//        /// Edit Tbl_DimOffice POST Works
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Edit_Post_Works()
//        {
//            // Arrange
//            var errorMessage = string.Empty;
//            var id = 1;
//            var expectedData = SampleDataManager.TestTbl_DimOffice[0];
//            expectedData.OfficeName = "UnitTest 1";
...
//        /// <summary>
//        /// Delete Tbl_DimOffice GET Works
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Delete_Get_Works()
//        {
//            // Arrange
//            var expectedData = new Tbl_DimOffice();

//            // Act
//            var result = controller.Delete(SampleDataManager.TestTbl_DimOffice[0].OfficeID) as ViewResult;
...
//        /// <summary>
//        /// Delete Tbl_DimOffice GET Not Found Fails
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Delete_NotFound_Fails()
//        {
//            // Arrange
//            var expectedHttpStatus = 404;
...
//        /// <summary>
//        /// Delete Tbl_DimOffice POST Works
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Delete_Post_Works()
//        {
//            // Arrange
//            var data = new Tbl_DimOffice() { OfficeID = 87, OfficeName = "Unit Test 87" };

//            // Act
//            try
//            {
//                var resultsAdd = repository.Add(UserNameAdmin, data);
//                var resultFind = repository.FindOne(UserNameAdmin, data.OfficeID);
//                var result = controller.Delete(resultFind.OfficeID, resultFind);
...
//        /// </summary>
//        [TestMethod]
//        public void View_Tbl_DimOffice_Create_Dispose_Works()
//        {
//            var errorMessage = string.Empty;

//            // Arrange
//            var controller = new Tbl_DimOfficeController();
...
//            {
//                BuildTbl_DimOfficeRepository();
//                controller = new Tbl_DimOfficeController(repository);
